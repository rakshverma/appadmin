                    ...
                    <div className="col-md-4">
                      <div className="form-group">
                        <Select
                          ...
                          register={register}
                          validationObj={{
                            required: "Please select status of franchise",
                          }}
                          options={[
                            { id: 1, name: "Active" },
                            { id: 0, name: "Inactive" },
                          ...
                          // defaultValue={franchiseDetails?.status}
                        />
                      </div>
                    </div>
                      ...
                      <div className="form-group">
                        <>
                          ...
                          >
                            ...
                            {districts.length &&
                              districts.map((item: any, i: any) => (
                                <option value={item.id} key={`category_${i}`}>
                                  {item.name}
                                </option>
                              ))}
                          </select>
                          {errors && errors?.district && <p style={{ color: "red" }}>{errors?.district || ""}</p>}
                        </>
                        {/* <Select
                          label={"District"}
                          name={"district"}
